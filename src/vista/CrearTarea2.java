...
public class CrearTarea2 extends javax.swing.JFrame{
    ...
    String usuarioSeleccionado = "Sin designar"; // Usuario predefinido por defecto
    ...
    if (nombre.isEmpty() || descripcion.isEmpty() || prioridad.isEmpty() || estado.isEmpty() || fechaInicioTexto.isEmpty() || fechaFinTexto.isEmpty()) {
    ...
    // Crear el objeto Tarea con el usuario "Sin designar"
