...
private void ajustarAlturaFilas() {
    ...
    private void initComponents() {
        ...
        crearTarea.setText("Usuario");
        jPanel1.add(crearTarea);
        crearTarea.setBounds(300, 430, 70, 20);

        imagen1.setText("imagen1");
        imagen1.setRuta("/resources/Lupa.png");
        jPanel1.add(imagen1);
        imagen1.setBounds(450, 430, 46, 40);
        ...
        crearTarea1.setBounds(190, 10, 420, 50);
        ...
        crearTarea2.setBounds(0, 430, 80, 20);
        ...
        descripcionFiltro.setBounds(500, 430, 110, 22);
        ...
        crearTarea3.setText("Estado");
        jPanel1.add(crearTarea3);
        crearTarea3.setBounds(160, 430, 60, 20);

        imagen2.setText("imagen1");
        imagen2.setRuta("/resources/listar.png");
        jPanel1.add(imagen2);
        imagen2.setBounds(10, 0, 70, 70);
